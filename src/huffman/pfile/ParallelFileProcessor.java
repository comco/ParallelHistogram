...
public class ParallelFileProcessor {
	...
	public long processFile() throws InterruptedException {
		LOGGER.fine("starting parallel file processing");

		long startTime = System.nanoTime();
		for (Thread t : threads) {
			t.start();
		}
		LOGGER.fine("waiting for parallel jobs to finish");
		
		for (Thread t : threads) {
			t.join();
		}
		long elapsedTime = System.nanoTime() - startTime;
		LOGGER.fine("parallel file processing finished for: " + elapsedTime / 1000 / 1000 + "milliseconds");
